...
const ITEMS: { name: WalletChoice; icon: string; hint?: string }[] = [
    ...
    >
      ...
      >
        ...
        <div className="px-5 pb-4 pt-2 text-xs text-slate-400">
          Astuce mobile : ouvrez cette page dans le navigateur intégré de votre
          wallet pour autoriser la connexion.
        </div>
      </div>
    </div>
  );
